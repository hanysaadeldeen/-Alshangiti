  ...
  <section class="BlogSection max-w-[1315px] mx-auto max-2xl:px-6">
    ...
    >
      ...
      <div class="flex gap-4 items-center justify-end max-md:justify-start">
        <button
          class="relative overflow-hidden border w-fit px-6 py-2.5 flex flex-col max-h-[46px] justify-center items-center gap-4 transition-all duration-300 cursor-pointer group ease-in-out bg-primary-500 text-white hover:bg-primary-600 active:bg-primary-700 border-transparent"
        >
          <nuxt-link
            :to="localePath('/blogs')"
