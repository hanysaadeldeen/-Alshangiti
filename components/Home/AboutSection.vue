        ...
        <div class="container mx-auto ">
            <div class="flex max-md:flex-col gap-8 justify-between items-center">
                ...
                <div class="text-text flex-grow max-w-[731px]">
                    ...
                    <!-- Description -->
                    <div class="font-normal text-base md:text-lg mb-6 flex flex-col gap-4">

                        <p class="text-justify">

                            تأسس مكتب محمود الشنقيطي للمحاماة والاستشارات القانونية عام 2005م، وقد حقق اعترافا وتقديرا
                            مهنياً واسعا، ونموذجا متقدما لفريق محلي يعمل وفقاً للمعايير الدولية في قطاع المحاماة
                            والاستشارات
                            القانونية.
                        </p>
                        ...
                        <p class="text-justify">
                            ...
                            إنّ قيادات التحول السعودية من الفئة الشابة ثنائي اللغة محلياً ودولياً، وسنحافظ على نفس هذا
                            الخط
                            العمري بفريق في أغلبه من الجيل الجديد الديناميكي، والذي يتميز بتبسيط عمله والاختصار وتنفيذ
                            الخدمة بذكاء مما ينعكس على مناولة الخدمة بقيمة عادلة.
                        </p>

                        <p class="text-justify">
                            كما سنعمل بشكل يومي على تعميق معرفتنا النظرية وتطبيقاتها العملية في مسارنا مستلهمين فلسفة
                            قطاع
                            الأعمال بتحويل خامتنا المصقولة الى منحوته فريدة.</p>
