  ...
  <section class="ServicesSection">
    <div class="border-b border-[#D3D3D3] pb-[76px]">
      <div class="max-w-[1315px] mx-auto max-2xl:px-6">
        <h2
          class="text-text mb-2 font-bold text-2xl lg:text-[40px] lg:!leading-[72px] max-w-[624px]"
        >
          {{ $t("homePage.services.title") }}
        </h2>
        <p
          class="text-[#5E5E5E] text-lg md:text-xl lg:text-2xl font-normal max-w-[624px] text-justify"
        >
