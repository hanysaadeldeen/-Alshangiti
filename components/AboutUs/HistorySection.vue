...
const items = ref([
    ...
    { title: "عام 2005", desc: "استقل المؤسس عن العمل الحكومي وأسس شركة محمود الشنقيطي للمحاماة والاستشارات القانونية، متخصصًا في خدمات قطاع الأعمال. كان الهدف هو سد فجوة في هذا القطاع وتوفير خدمات قانونية متخصصة.", active: false },
